...
{	//音を増やしたいときはここ
	{"data/BGM/op.wav", -1},		// OP -1にするとループする
	{"data/BGM/battle2.wav", -1},	// GAME
	{"data/BGM/clear.wav", -1},		// クリア
	{ "data/BGM/gameover.wav", 0 },		// ゲームオーバー
	{ "data/SE/sword1.wav",0 },		//剣
	{ "data/SE/nail.wav",0 },		//ひっかき
	{ "data/SE/damage.wav",0 },		//被ダメ
	{ "data/SE/charge1.wav",0 },		//チャージ
	{ "data/SE/charge_end.wav",0 },		//チャージ終了
	{ "data/SE/magic.wav",0 },		//魔法
	{ "data/SE/break.wav",0 },		//破壊音
	{ "data/SE/cat.wav",0 },		//にゃーん
