...
#define RELOGO_POS_X		(0)		//ポリゴン位置X
#define RELOGO_POS_Y		(0)		//ポリゴン位置Y
#define RELOGO_SIZE_X		(1280)	//ポリゴンサイズX
#define RELOGO_SIZE_Y		(720)	//ポリゴンサイズY
#define RELOGO_CHARSIZE_X	(300)	//ポリゴンサイズX
#define RELOGO_CHARSIZE_Y	(105)	//ポリゴンサイズY
