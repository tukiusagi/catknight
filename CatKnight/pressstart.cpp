...
void InitStart(void)
{
	...
	{
		g_Startpos = D3DXVECTOR3(START_SIZE_X / 2, START_SIZE_Y / 2, 0.0f);
	}
...
void UpdateStart(void)
{
	...
	if (GetKeyTrigger(DIK_RETURN) || GetJoystickTrigger(PAD_START) || GetxControllerTrigger(XINPUT_PAD_START))	//Startで終了
	{
		nInvisible = 0.5;
	}
