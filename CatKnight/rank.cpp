...
#define	TEXTURE_FIRST		"data/TEXTURE/first.png"	// 読み込むテクスチャファイル名
#define	TEXTURE_SECOND		"data/TEXTURE/second.png"	// 読み込むテクスチャファイル名
#define	TEXTURE_THIRD		"data/TEXTURE/third.png"	// 読み込むテクスチャファイル名
